...
import al.arra.api.flickr.exception.OAuthConnectionException;
...
public class HTTPRequest {
    ...
    private static RequestTracker NOOP = new RequestTracker() {
        @Override public void track(HTTPRequest request){
     ...
     */
    public HTTPResponse send(RequestTracker tuner)
    {
        try
        {
            createConnection();
